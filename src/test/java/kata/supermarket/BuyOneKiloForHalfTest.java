...
class BuyOneKiloForHalfTest {
    ...
    void hasExpectedTotalDiscount(String description, String expectedDiscountTotal, List<Item> items) {
        ...
        final Discount discount = new DiscountByKilo(items, new BigDecimal(1), new BigDecimal(0.5));
...
//        System.out.println(map);
    ...
    private static Arguments aSingleItemPricedByWeight() {
        return Arguments.of("a single weighed item", "4.99", Collections.singletonList(twoFiftyGramsOfAmericanSweets()));
    }

    private static Arguments multipleItemsPricedByWeight() {
        return Arguments.of("multiple weighed items", "4.99",
    ...
    private static Item twoFiftyGramsOfAmericanSweets() {
        return aKiloOfAmericanSweets().weighing(new BigDecimal("2.25"));
    }
