...
class BuyTwoForOnePoundTest {
    ...
    void hasExpectedTotalDiscount(String description, String expectedDiscountTotal, List<Item> items) {
        ...
        final Discount discount = new DiscountByPrice(items, new BigDecimal(2), new BigDecimal(1));
...
//        System.out.println(map);
    ...
    private static Arguments multipleItemsPricedPerUnit() {
        return Arguments.of("multiple items priced per unit", "4.06",
